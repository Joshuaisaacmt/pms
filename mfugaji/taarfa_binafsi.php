                    ...
                    <form method="POST">
                        ...
                        <div class="card-body" >
                            ...
                            <div class="form-group"  style="width:50%; float:left;">
                                ...
                                <input type="text"  class="form-control"  style="width:70%;"value="<?php echo $product_type; ; ?>" readonly>
                            </div>
                            <div class="form-group"  style="width:50%; float:left;">
                                <label> Idadi Kuku</label>
                                <input type="text"  class="form-control"  style="width:60%;"value="<?php echo $product_qnty; ; ?>" readonly>
                            </div>
                            <div class="form-group"  style="width:50%; float:left;">
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <div class="modal-body">
                <h1 class="text-center bg-dark"> <b> BADILISHA TAARIFA </b> </h1>
                    <form method="POST" action="">
                        <div class="card-body" >
                            ...
                            <div class="form-group"  style="width:50%; float:left;">
                                <label> Idadi Kuku</label>
                                <input type="number"  class="form-control"  name="product_qnty"
                                         style="width:90%;" value="<?php echo $product_qnty; ; ?>" >
                            </div>
                            <div class="form-group"  style="width:50%; float:left;">
                                <label> Tarehe ya Usajili</label>
                                <input type="date"  class="form-control"   name="tarh_arrival"
                                         style="width:90%;" value="<?php echo $tarh_arrival; ; ?>" >
                            </div>
                            <div class="form-group"  style="width:50%; float:left;">
                                <label> Tarehe ya Kuuza</label>
