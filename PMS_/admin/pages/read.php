...
<?php
  ...
  <?php
      ...
      // idadi ya Wafugaji
      $count1 = "SELECT COUNT(*) as role1  FROM message  WHERE sender = '$fname' AND sms_status = 0";
      ...
      if(mysqli_num_rows($count_query)){
       ...
       // idadi ya Wafugaji
       $count2 = "SELECT COUNT(*) as role2  FROM message  WHERE sender = '$fname' AND sms_status = 1";
          ...
          <div class="card card-primary card-outline">
            ...
            <div class="card-body p-0">
              ...
              <?php
                  ...
                  $sql = "SELECT * FROM message WHERE sender = '$selected' AND sms_status = 1";
